      ...
      <div class="wrapper">
          <form action="" @submit="login">
              <div class="logo-headline">
                  <img alt="logo" src="./siddhatech.png" width="150" height="80">
                  <h1>Kass</h1>
              </div>
              <div class="input-box">
                  <h2>Welcome!</h2>
              ...
              <div  class="input-box">
                  <input type="test" placeholder="Username" v-model="username" name="username">
...
.wrapper .logo-headline{
    display: flex;
}
.wrapper .logo-headline  img{
    padding-top: 10%;
    padding-left: 15%;
}
